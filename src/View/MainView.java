...
public class MainView extends JFrame implements Observer{
	...
	public MainView(Observable observable) {
		...
		label_balance.setFont(new Font("±¼¸²", Font.PLAIN, 15));
		label_balance.setBounds(12, 59, 341, 21);
		if(comboBox.getItemCount()==0)
		{
			label_balance.setText("°³¼³µÈ °èÁÂ°¡ ¾ø½À´Ï´Ù. °èÁÂ¸¦ Ãß°¡ÇØÁÖ¼¼¿ä.");
		}
		else
		{
			label_balance.setText("ÀÜ¾×");
		}
		...
		btnNewButton_4.addActionListener(new ActionListener() { //°Å·¡³»¿ª ¹öÆ°
			public void actionPerformed(ActionEvent e) {
				c = new OpenTransactionHistoryView();
				c.execute();
			}
		});
		btnNewButton_3.addActionListener(new ActionListener() {//°èÁÂÀÌÃ¼ ¹öÆ°
			public void actionPerformed(ActionEvent e) {
				c = new OpenAccountTransferView();
				c.execute();
			}
		});
		btnNewButton_2.addActionListener(new ActionListener() { //Ãâ±Ý ¹öÆ°
			public void actionPerformed(ActionEvent e) {
		...
		btnNewButton_1.addActionListener(new ActionListener() { //ÀÔ±Ý ¹öÆ°
			public void actionPerformed(ActionEvent e) {				
