...
public class MainView extends JFrame implements Observer{
	...
	public MainView(Observable observable) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) { //∏∂¿Ã∆‰¿Ã¡ˆ πˆ∆∞
		...
		username = new JLabel("");
		username.setFont(new Font("±º∏≤", Font.BOLD, 22));
		...
		lblNewLabel_7.setFont(new Font("±º∏≤", Font.PLAIN, 16));
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) { //∞Ë¡¬ µÓ∑œ
		...
		btnNewButton_4.addActionListener(new ActionListener() { //∞≈∑°≥ªø™ πˆ∆∞
			public void actionPerformed(ActionEvent e) {
				c = new OpenTransactionHistoryView();
				c.execute();
			}
		});
		btnNewButton_3.addActionListener(new ActionListener() {//∞Ë¡¬¿Ã√º πˆ∆∞
			public void actionPerformed(ActionEvent e) {
				c = new OpenAccountTransferView();
				c.execute();
			}
		});
		btnNewButton_2.addActionListener(new ActionListener() { //√‚±› πˆ∆∞
			public void actionPerformed(ActionEvent e) {
		...
		btnNewButton_1.addActionListener(new ActionListener() { //¿‘±› πˆ∆∞
			public void actionPerformed(ActionEvent e) {				
